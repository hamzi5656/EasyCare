...
class Physcatrist extends StatefulWidget {
  
  Physcatrist({super.key, });

  @override
  State<Physcatrist> createState() => _ServiceDetailsState();
}

class _ServiceDetailsState extends State<Physcatrist> {
  @override
               ...
               Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                         AssetImage("asset/images/physco.jpg"),
                    fit:BoxFit.fill )
                    ),
                  ),
                    Positioned(top: 20,
...
style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),                              
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("1500",style: TextStyle(fontSize: 16),
                                      ),
                                    ],
                                  ),
                                  Row(
                                             ...
                                             child: Padding(
                                                                 ...
                                                                 child: Row(
                                                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                                   children: [
                                                                    CircleAvatar(
                                             backgroundImage:AssetImage("asset/images/physco.jpg") ,
