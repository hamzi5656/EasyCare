...
class GymTrainer extends StatefulWidget {
  
  GymTrainer({super.key, });

  @override
  State<GymTrainer> createState() => _ServiceDetailsState();
}

class _ServiceDetailsState extends State<GymTrainer> {
  @override
...
style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),                              
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("60 min",style: TextStyle(fontSize: 16),
                                      ),
                                    ],
                                  ),
                                ],),
                         ...
                         Text("Im a professional gym trainner with experience of 5 years",
                         ), 
