...
class VisualAids extends StatefulWidget {
  const VisualAids({super.key});

  @override
  State<VisualAids> createState() => _MobilityState();
}

class _MobilityState extends State<VisualAids> {
  ...
  @override
   ...
   getMobilityProducts(){
      ...
      FirebaseFirestore.instance.collection("Product").where("category", isEqualTo: "blind").where("popular", isEqualTo: false).get().then((response) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Visual Aids",style: TextStyle(color: Colors.white),),
