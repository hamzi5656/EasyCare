...
class HeaeringAids extends StatefulWidget {
  const HeaeringAids({super.key});

  @override
  State<HeaeringAids> createState() => _MobilityState();
}

class _MobilityState extends State<HeaeringAids> {
  ...
  @override
   ...
   getMobilityProducts(){
      ...
      FirebaseFirestore.instance.collection("Product").where("category", isEqualTo: "deaf").where("popular", isEqualTo: false).get().then((response) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Hearing Aids",style: TextStyle(color: Colors.white),),
