...
class _MobilityState extends State<Mobility> {
  ...
  @override
   ...
   getMobilityProducts(){
      ...
      FirebaseFirestore.instance.collection("Product").where("category", isEqualTo: "Mobility").where("popular", isEqualTo: false).get().then((response) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Mobility",style: TextStyle(color: Colors.white),),
