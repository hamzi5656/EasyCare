...
import 'package:auth/User/Categories/categories.dart';
      ...
      class NotPopular extends StatefulWidget {
      const NotPopular({super.key});

      @override
      State<NotPopular> createState() => _NotPopularState();
      }

      class _NotPopularState extends State<NotPopular> {
